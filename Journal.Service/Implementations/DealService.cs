        ...
        public async Task<BaseResponse<DealResponseModel>> GetDeal(long positionid, Guid accountId)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (account == null) account = _matchTradeAccountRepository.SelectAll().FirstOrDefault(x => x.Id == accountId);
